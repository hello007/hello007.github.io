...
系统会根据标题中的关键词自动选择相应的 Emoji 图标：

| 图标 | 关键词 | 适用场景 |
|------|--------|----------|
| 🎯 | 掌握、目标、学习 | 学习目标、掌握要点 |
| 📖 | 详解、详细、说明、介绍 | 详细说明、介绍性内容 |
| 🤖 | AI、智能、模型、LLM、大语言 | AI模型、LLM相关 |
| ⚙️ | 应用、技术、开发 | 应用技术、开发相关 |
| 🏗️ | 工程、架构、框架、系统 | 工程架构、系统设计 |
| 📊 | 数据、知识、向量、数据库 | 数据处理、知识库、向量数据库 |
| 🔒 | 安全、合规、隐私、防护 | 安全防护、合规要求 |
| 🛠️ | 方法、工具、技巧、实践 | 工具方法、实践技巧 |
| 💡 | 概念、基础、入门、原理 | 基础概念、原理说明 |
| ⭐ | 核心、重要、关键 | 核心内容、重要要点 |
| 🎨 | 设计、模式、架构 | 设计模式、架构设计 |
| ✅ | 测试、验证、检查 | 测试验证、检查清单 |
| ❓ | 问题、问答、Q&A、FAQ | 问题解答、FAQ |
| ⚠️ | 警告、注意、提示 | 注意事项、警告提示 |
| 🚀 | 进阶、前沿、高级、深入 | 进阶内容、前沿技术 |
| 📝 | 总结、回顾、概览 | 总结回顾、内容概览 |
| 🔧 | 环境、配置、安装、部署 | 环境配置、部署相关 |
| ⚡ | 性能、优化、提升 | 性能优化、提升技巧 |
| 🎬 | 示例、案例、演示 | 示例演示、案例分析 |
| 📋 | 协议、标准、规范 | 协议标准、规范说明 |
| 🤝 | 协作、通信、交互 | 协作通信、交互设计 |
...
- **自动转换 `.md` 扩展名为 `.html`**：链接指向 `.md` 文件时自动转换为 `.html`
  - 例如：`[文档](guide.md)` → `<a href="guide.html">文档</a>`
